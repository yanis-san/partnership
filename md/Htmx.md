...
## [1.x to 2.x Migration Guide](https://htmx.org/docs/#1-x-to-2-x-migration-guide)
...
### [Via A CDN (e.g. jsDelivr)](https://htmx.org/docs/#via-a-cdn-e-g-jsdelivr)
...
### [Download a copy](https://htmx.org/docs/#download-a-copy)

The next easiest way to install htmx is to simply copy it into your project.

Download `htmx.min.js` [from jsDelivr](https://cdn.jsdelivr.net/npm/htmx.org@2.0.7/dist/htmx.min.js) and add it to the appropriate directory in your project and include it where necessary with a `<script>` tag:
...
### [Triggering Requests](https://htmx.org/docs/#triggers)
...
#### [Extended CSS Selectors](https://htmx.org/docs/#extended-css-selectors)
...
#### [Morph Swaps](https://htmx.org/docs/#morphing)
...
#### [Swap Options](https://htmx.org/docs/#swap-options)
...
#### [Details](https://htmx.org/docs/#details)
...
#### [Troublesome Tables](https://htmx.org/docs/#troublesome-tables)
...
#### [Selecting Content To Swap](https://htmx.org/docs/#selecting-content-to-swap)
...
#### [Preserving Content During A Swap](https://htmx.org/docs/#preserving-content-during-a-swap)
...
#### [File Upload](https://htmx.org/docs/#files)
...
#### [Extra Values](https://htmx.org/docs/#extra-values)
...
### [Confirming Requests](https://htmx.org/docs/#confirming)
...
#### [Confirming Requests Using Events](https://htmx.org/docs/#confirming-requests-using-events)
...
### [Progressive Enhancement](https://htmx.org/docs/#progressive_enhancement)
...
### [Specifying History Snapshot Element](https://htmx.org/docs/#specifying-history-snapshot-element)
...
### [Undoing DOM Mutations By 3rd Party Libraries](https://htmx.org/docs/#undoing-dom-mutations-by-3rd-party-libraries)
...
### [Disabling History Snapshots](https://htmx.org/docs/#disabling-history-snapshots)
...
### [Configuring Response Handling](https://htmx.org/docs/#response-handling)
...
#### [Configuring Response Handling Examples](https://htmx.org/docs/#response-handling-examples)
...
### [Request Order of Operations](https://htmx.org/docs/#request-operations)
...
### [Validation Example](https://htmx.org/docs/#validation-example)
...
### [Core Extensions](https://htmx.org/docs/#core-extensions)
...
### [Installing Extensions](https://htmx.org/docs/#installing-extensions)

The fastest way to install htmx extensions created by others is to load them via a CDN. Remember to always include the core htmx library before the extensions and [enable the extension](https://htmx.org/docs/#enabling-extensions). For example, if you would like to use the [response-targets](https://htmx.org/extensions/response-targets) extension, you can add this to your head tag:
...
Note: [Idiomorph](https://htmx.org/extensions/idiomorph) does not follow the naming convention of htmx extensions. Use `idiomorph` instead of `htmx-ext-idiomorph`. For example, `https://cdn.jsdelivr.net/npm/idiomorph` or `npm install idiomorph`.
...
### [Enabling Extensions](https://htmx.org/docs/#enabling-extensions)
...
The following example shows how to enable [response-targets](https://htmx.org/extensions/response-targets) extension, allowing you to specify different target elements to be swapped based on HTTP response code.
...
### [Creating Extensions](https://htmx.org/docs/#creating-extensions)
...
### [Initialize A 3rd Party Library With Events](https://htmx.org/docs/#init_3rd_party_with_events)
...
### [Configure a Request With Events](https://htmx.org/docs/#config_request_with_events)
...
### [Modifying Swapping Behavior With Events](https://htmx.org/docs/#modifying_swapping_behavior_with_events)
...
### [Event Naming](https://htmx.org/docs/#event_naming)
...
### [Logging](https://htmx.org/docs/#logging)
...
### [Creating Demos](https://htmx.org/docs/#creating-demos)
...
#### [Demo Example](https://htmx.org/docs/#demo-example)
...
### [3rd Party Javascript](https://htmx.org/docs/#3rd-party)
...
### [Rule 1: Escape All User Content](https://htmx.org/docs/#rule-1-escape-all-user-content)
...
### [htmx Security Tools](https://htmx.org/docs/#htmx-security-tools)
...
#### [Configuration Options](https://htmx.org/docs/#configuration-options)
...
#### [Events](https://htmx.org/docs/#events-1)
...
### [CSP Options](https://htmx.org/docs/#csp-options)
...
A full discussion of CSPs is beyond the scope of this document, but the [MDN Article](https://developer.mozilla.org/en-US/docs/Web/HTTP/CSP) provides a good jumping-off point for exploring this topic.

### [CSRF Prevention](https://htmx.org/docs/#csrf-prevention)
...
## [Configuring htmx](https://htmx.org/docs/#config)
...
## [Conclusion](https://htmx.org/docs/#conclusion)
